...
<template>
  <div class="sticker-container h-full w-full bg-white p-[6px] text-[var(--cover-main-color)] dark:bg-[#30363d] rounded-[10px] overflow-hidden">
    <div class="box pointer-events-none h-full w-full flex flex-col items-center justify-center rounded-[8px] bg-[var(--cover-main-color)] text-center font-bold font-[fantasy]">
      <!-- 椭圆 -->
