...
<template>
  <ShadowCard class="justify-between !p-[5px]">
    ...
    <div class="flex flex-row justify-end gap-4 px-6">
      ...
      <!-- GitHub -->
      <a title="GitHub" class="detail-arrow" :href="SITE.githubHome" target="_blank">
      ...
      <!-- Email -->
      <a title="GitHub" class="detail-arrow" :href="SITE.mail" target="_blank">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><rect width="20" height="16" x="2" y="4" rx="2" /><path d="m22 7l-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7" /></g></svg>
      </a>
    </div>
  </ShadowCard>
</template>
