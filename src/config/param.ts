...
export const SITE = {
  title: '博客',
  author: 'RookieOHY',
  description: '记录 RookieOHY 的不枯燥生活',
  profileContent: '我是RookieOHY，目前生活在北京的开发者。我很喜欢 Java、Golang。目前从事服务端开发工作 。',
  keywords: 'RookieOHY, Blog, 后端, Java, 博客',
  coordinate: [116.3912757, 39.906217],
  ...
  juejin: 'https://juejin.cn/user/1662117314041480/posts',
  mail: 'mailto:204130199@qq.com',
  homePage: '/',
  profilePage: '/profile',
  twitterId: 'ouhuanyu',
  twitterUrl: 'https://x.com/ouhuanyu',
  githubId: 'RookieOHY',
  githubHome: 'https://github.com/RookieOHY',
  weeklyUrl: 'https://weekly.subhee.top/',
  repo: 'pinky-pig/what-is-my-astro-blog',
  notion: 'https://fork-hibiscus-2d3.notion.site/Reading-List-b8c88c0348914c009e6f7d699f2e0b87',
